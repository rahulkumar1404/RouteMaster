...
export default class Register extends Component {
	...
	*/
    ...
    return (
        <div class='pt-5'>
            <Header />
			<div class="py-5" style={{backgroundImage: `url(${busBG})`,backgroundSize:'cover',overflow: 'hidden', height: '1000px'}}>
				<div className="row mb-4">
					<div className="col-lg-8 mx-auto text-center">
					<h1 className="display-6" style={{color:'black', fontWeight:'700'}}>Registration</h1>
					</div>
				</div> 
				<div className="row">
